...
<div class="card mb-3">
    <div class="card-body py-3">
        <form method="GET" action="/reports/sales-statement" class="row g-3 align-items-end">
            ...
            <div class="col-md-1">
                <a href="/reports/sales-statement/export?from=<?= urlencode($from ?? '') ?>&to=<?= urlencode($to ?? '') ?>&customer_id=<?= urlencode($customer_id ?? '') ?>" class="btn btn-outline-success btn-sm w-100"><i class="bi bi-file-earmark-excel me-1"></i> Export</a>
            </div>
        </form>
    </div>
</div>
...
<div class="card">
    <div class="card-body p-0">
        ...
        <table class="table table-hover mb-0">
            <thead><tr>
                <th>Date</th><th>Type</th><th>Ref #</th><th>Customer</th><th>VAT No</th><th>Branch</th><th>Address</th>
