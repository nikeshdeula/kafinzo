    ...
    <div class="card-body py-3">
        <form method="GET" action="/sales/bills" class="row g-2 align-items-end">
            ...
            <div class="col-md-1">
                ...
                <input type="text" name="search" class="form-control form-control-sm" placeholder="Name, bill #" value="<?= htmlspecialchars($search ?? '') ?>">
            </div>
            <div class="col-md-1">
        ...
        <div class="mt-2">
            <a href="/sales/bills/export<?= http_build_query(array_filter(['customer_id'=>$customer_id??'', 'status'=>$status??'', 'from'=>$from??'', 'to'=>$to??'', 'search'=>$search??''])) ?>" class="btn btn-success btn-sm"><i class="bi bi-file-earmark-excel me-1"></i> Export Excel</a>
        </div>
    </div>
</div>
    ...
    <div class="card-body p-0">
        ...
        <table class="table table-hover mb-0">
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($b['customer_vat'] ?? '—') ?></td>
