...
<form action="<?= $action ?>" method="POST">
    <div class="row g-3">
        ...
        <div class="col-md-6"><label class="form-label fw-600">Branch</label>
            <input type="text" name="branch" class="form-control" placeholder="e.g. Main Branch, New Baneshwor" value="<?= htmlspecialchars($supplier['branch'] ?? '') ?>"></div>
        ...
        <div class="col-md-6"><label class="form-label fw-600">Van Number</label>
            <input type="text" name="van_number" class="form-control" placeholder="e.g. Ba 1 KHA 1234" value="<?= htmlspecialchars($supplier['van_number'] ?? '') ?>"></div>
