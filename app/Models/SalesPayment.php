...
class SalesPayment {
    ...
    public function create(array $d): int {
        ...
        $s->execute(['bid'=>$d['business_id']??($_SESSION['business_id']??1),'iid'=>$d['invoice_id'],'cid'=>$d['customer_id'],'pdate'=>$d['payment_date'],'method'=>$d['payment_method'],'ref'=>$d['reference_number']??null,'amount'=>$d['amount'],'notes'=>$d['notes']??null]);
